function [P,z,ETleafcrit]=TreeWaterPotential(ETmm, daylength,P0, L, LAI, k0s, h0s, a, bTs, bs)
% by Giulia Vico (8/2/2023)
% light edits by Yuval Zelnik (24/11/2023)
...
%k0s: dependece of saturated hydraulic conductivity at the base of the tree (z = 0) on L
...
z=L;% take just the top point in this case
